...
export declare class NgMaterialMultilevelMenuComponent implements OnInit, OnChanges, OnDestroy {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<NgMaterialMultilevelMenuComponent, "ng-material-multilevel-menu", never, { "configuration": "configuration"; "items": "items"; }, { "selectedItem": "selectedItem"; "selectedLabel": "selectedLabel"; "menuIsReady": "menuIsReady"; }, ["listTemplate"], never>;
}
